...
wb = load_workbook("C://Users//RAHUL N//OneDrive//Desktop//excel.xlsx") 
  
#database connection
connection = pymysql.connect(host="127.0.0.1",
user="root",passwd="",database="Student")
...
def insert(): 
	...
	# Data inserting into database End 
        ...
        # save the file 
        wb.save("C://Users//RAHUL N//OneDrive//Desktop//excel.xlsx") 
...
if __name__ == "__main__": 
    ...
    # create a Form label 
    heading = Label(root, text="Student Registration Form", fg="Red") 
